...
public class LessThanOrEqual extends Piece{
	private static final long serialVersionUID = -6592108063139472469L;

	private ValueDouble input1;
	private ValueDouble input2;
	private ValueBoolean output;
	public LessThanOrEqual(final int x, final int y,  final ProgrammingSpaceInterface space) {
