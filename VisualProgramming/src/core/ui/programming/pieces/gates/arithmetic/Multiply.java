...
public class Multiply extends Piece{
	private static final long serialVersionUID = -5246090456227482729L;
	//v1 - v2 = v
	private ValueDouble v1;
	private ValueDouble v2;
	private ValueDouble v;
	public Multiply(final int x, final int y, final ProgrammingSpaceInterface space) {
